...
def main():
    ...
    if geo_data_file is not None:
        try:
            ...
            if missing_columns:
                ...
                with st.expander("📊 Uploaded Geopolitical Data Preview"):
    ...
    # Predict button
    predict_btn = st.sidebar.button("🔮 Predict Stock Prices", type="primary", disabled=geo_data is None)
    ...
    if predict_btn and geo_data is not None:
        with st.spinner("Fetching data and making predictions..."):
            try:
                ...
                ax1.plot(results['Date'], results['Actual_Close'], label='Actual Price', color='blue', linewidth=2)
                ax1.plot(results['Date'], results['Predicted_Close'], label='Predicted Price', color='red', linestyle='--', linewidth=2)
                ...
                ax2.plot(results['Date'], diff, label='Prediction Difference', color='green', linewidth=2)
                ax2.fill_between(results['Date'], diff, 0, color='green', alpha=0.3)
                ax2.set_title('Prediction Difference', fontsize=14)
